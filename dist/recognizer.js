...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'recognizer.data';
    var REMOTE_PACKAGE_BASE = 'recognizer.data';
...
Module['FS_createPath']('/', 'voxforge', true, true);
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_recognizer.data');

    };
    Module['addRunDependency']('datafile_recognizer.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 682, "filename": "/voxforge/sample.voca"}, {"start": 682, "audio": 0, "end": 845, "filename": "/voxforge/sample.term"}, {"start": 845, "audio": 0, "end": 1368, "filename": "/voxforge/LICENSE"}, {"start": 1368, "audio": 0, "end": 2256, "filename": "/voxforge/sample.grammar"}, {"start": 2256, "audio": 0, "end": 2713, "filename": "/voxforge/sample.dict"}, {"start": 2713, "audio": 0, "end": 2440698, "filename": "/voxforge/hmmdefs"}, {"start": 2440698, "audio": 0, "end": 2495828, "filename": "/voxforge/tiedlist"}, {"start": 2495828, "audio": 0, "end": 2496032, "filename": "/voxforge/sample.dfa"}], "remote_package_size": 2496032, "package_uuid": "2cf6f114-f23e-429e-abd2-35eee2186fb9"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 7525872,
    DYNAMIC_BASE = 7525872,
    DYNAMICTOP_PTR = 2282960;
...
var wasmBinaryFile = 'recognizer.wasm';
...
var ASM_CONSTS = [function() { setTimeout(Module.cwrap('main_event_recognition_stream_loop'), 0); },
 function($0) { setTimeout(Module.cwrap('event_recognize_stream', 'number', ['number']).bind(null, $0), 0); },
 function() { Module.ccall('end_event_recognition_stream_loop'); },
 function($0) { setRate(+$0); },
 function() { begin() }];
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=2282816;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 2282864, 4), 2282864);
...
function nullFunc_fiiif(x) { err("Invalid function pointer called with signature 'fiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }

function nullFunc_fiiiif(x) { err("Invalid function pointer called with signature 'fiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
var real__end_event_recognition_stream_loop = asm["_end_event_recognition_stream_loop"]; asm["_end_event_recognition_stream_loop"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__end_event_recognition_stream_loop.apply(null, arguments);
};

var real__event_recognize_stream = asm["_event_recognize_stream"]; asm["_event_recognize_stream"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__event_recognize_stream.apply(null, arguments);
};
...
var real__fill_buffer = asm["_fill_buffer"]; asm["_fill_buffer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__fill_buffer.apply(null, arguments);
};
...
var real__main_event_recognition_stream_loop = asm["_main_event_recognition_stream_loop"]; asm["_main_event_recognition_stream_loop"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__main_event_recognition_stream_loop.apply(null, arguments);
};
...
var _end_event_recognition_stream_loop = Module["_end_event_recognition_stream_loop"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_end_event_recognition_stream_loop"].apply(null, arguments) };
var _event_recognize_stream = Module["_event_recognize_stream"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_event_recognize_stream"].apply(null, arguments) };
var _fflush = Module["_fflush"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_fflush"].apply(null, arguments) };
var _fill_buffer = Module["_fill_buffer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_fill_buffer"].apply(null, arguments) };
...
var _main_event_recognition_stream_loop = Module["_main_event_recognition_stream_loop"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_main_event_recognition_stream_loop"].apply(null, arguments) };
